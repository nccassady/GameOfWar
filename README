...
If you don't have Ruby installed on your machine, you can download the latest release in executable form through GitHub and run that like any other program.
